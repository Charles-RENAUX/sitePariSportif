...
public class MotDePasseServiceHash 
{
	    ...
	    public static void main(String[] args) {
	        System.out.println(String.format("Le mot de passe chiffré de bob est : %s",
	                MotDePasseServiceHash.genererMotDePasse("bobIsTheBest")));
	        System.out.println(String.format("Le mot de passe chiffré de jean est : %s",
	                MotDePasseServiceHash.genererMotDePasse("azerty")));
	        System.out.println(String.format("Le mot de passe chiffré de marie est : %s",
	                MotDePasseServiceHash.genererMotDePasse("123456")));
	    }
}
